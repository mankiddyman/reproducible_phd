...
v <- read_csv("tract_votes6.csv", show_col_types = FALSE)
...
write_csv(v, "tract_votes_blocks6.csv")
...
ggsave("FIG15b_block_skew6.png", p1, width = 12, height = 13, dpi = 170, device = agg_png)
cat("\nWROTE: FIG15b_block_skew6.png block_skew6.csv tract_votes_blocks6.csv\n")
