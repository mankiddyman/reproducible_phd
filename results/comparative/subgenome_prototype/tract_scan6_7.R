...
ggsave("FIG13c_tract_scan6.png", p, width = 12, height = 11, dpi = 170, device = agg_png)
write_csv(gene, "tract_gene_calls7.csv"); write_csv(per_lin, "tract_per_lineage7.csv")
cat("\nWROTE: FIG13c_tract_scan6.png tract_votes7.csv tract_gene_calls7.csv tract_per_lineage7.csv\n")
