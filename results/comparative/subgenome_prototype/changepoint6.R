...
res <- res %>% mutate(p_adj = p.adjust(p, "BH"),
  ...
  arrange(p)
write_csv(res, "changepoint_results6.csv")
...
ggsave("FIG19b_vote_tracks6.png", p1, width = 13, height = 11, dpi = 170, device = agg_png)
...
ggsave("FIG20b_changepoint_null6.png", p2 / p3, width = 8, height = 9, dpi = 180, device = agg_png)
cat("\nWROTE: FIG19b_vote_tracks6.png FIG20b_changepoint_null6.png changepoint_results6.csv\n")
