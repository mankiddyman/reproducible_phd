...
write_csv(v, "tract_votes_blocks.csv")
...
ggsave("FIG15_block_skew.png", p1, width = 12, height = 13, dpi = 170, device = agg_png)
cat("\nWROTE: FIG15_block_skew.png block_skew.csv tract_votes_blocks.csv\n")
