...
write_csv(asg, "block_subgenome_calls.csv")
...
ggsave("FIG10_block_calls.png", p, width = 11, height = 10, dpi = 170, device = agg_png)
cat("\nWROTE: FIG10_block_calls.png block_subgenome_calls.csv\n")
